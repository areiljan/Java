...
public class ClientTest {
    ...
    void clientBooksFreeRoomNoDiscountBecauseNotEnoughClients() throws OverlappingBookingException,
        ...
        client1.bookRoom(economyRoom, LocalDate.of(2024, 3, 29), new ArrayList<Service>());
    ...
    void clientBooksFreeRoomWithDiscountBecauseFirstInOrderingSystem() throws OverlappingBookingException,
            NotEnoughMoneyToBookException, CannotBookHotelIfNotClientException, RatingOutOfBoundsException, ReviewAlreadyWrittenException, CannotWriteReviewIfNotBookedInHotelException {
        ReservationSystem reservationSystem = new ReservationSystem();
        Hotel hotel = new Hotel("Grand Budapest", "Hungary", "Budapest", reservationSystem);
        Room suiteRoom = new Room(hotel, Room.RoomType.SUITE);
        ...
        client2.bookRoom(suiteRoom, LocalDate.of(2024, 3, 29), new ArrayList<Service>());
        client2.writeReview(hotel, "bad", 1);
        client3.bookRoom(suiteRoom, LocalDate.of(2024, 3, 30), new ArrayList<Service>());
        ...
        client4.bookRoom(suiteRoom, LocalDate.of(2024, 3, 31), new ArrayList<Service>());
    ...
    void clientBooksFreeRoomWithDiscountBecauseSecondInOrderingSystem() throws OverlappingBookingException,
        ...
        client1.bookRoom(suiteRoom, LocalDate.of(2024, 3, 31), new ArrayList<Service>());
    ...
    void clientBooksFreeRoomWithDiscountBecauseThirdInOrderingSystem() throws OverlappingBookingException,
        ...
        client2.bookRoom(suiteRoom, LocalDate.of(2024, 3, 31), new ArrayList<Service>());
    ...
    void clientFiltersHotelsByRating() throws NotEnoughMoneyToBookException,
            OverlappingBookingException, CannotBookHotelIfNotClientException, RatingOutOfBoundsException, ReviewAlreadyWrittenException, CannotWriteReviewIfNotBookedInHotelException {
        ReservationSystem reservationSystem = new ReservationSystem();
        Hotel hotel1 = new Hotel("Grand Budapest", "Hungary", "Budapest", reservationSystem);
        Hotel hotel2 = new Hotel("Grand Roma", "Italy", "Rome", reservationSystem);
        Hotel hotel3 = new Hotel("Grand Vatican", "Italy", "Rome", reservationSystem);
    ...
    void clientFiltersRoomsByPrice() {
        ...
        Assertions.assertEquals(expectedRoomList, client1.filterRooms(hotel, 4000));
    }

    @Test
    void clientBooksRoomWithAllServicesSubtractsMoney() throws CannotBookHotelIfNotClientException, NotEnoughMoneyToBookException, OverlappingBookingException {
        ReservationSystem reservationSystem = new ReservationSystem();
        Hotel hotel = new Hotel("Grand Budapest", "Hungary", "Budapest", reservationSystem);
        Room suiteRoom = new Room(hotel, Room.RoomType.SUITE);
        ...
        client1.bookRoom(suiteRoom, LocalDate.of(2024, 12, 12), servicesForClient1);

        Assertions.assertEquals(800, client1.getMoney());
    }

    @Test
    void clientBooksRoomWithAllServicesHasNoMoneyThrowsException() throws CannotBookHotelIfNotClientException, NotEnoughMoneyToBookException, OverlappingBookingException {
        ReservationSystem reservationSystem = new ReservationSystem();
        Hotel hotel = new Hotel("Grand Budapest", "Hungary", "Budapest", reservationSystem);
        Room economyRoom = new Room(hotel, Room.RoomType.ECONOMYROOM);
        Client client1 = new Client("Joonas", 2000, reservationSystem);
        ...
        Assertions.assertThrows(NotEnoughMoneyToBookException.class,
                () -> client1.bookRoom(economyRoom, LocalDate.of(2024, 12, 12), servicesForClient1));
    }

    @Test
    void clientHasAccessToServicesThroughBooking() throws CannotBookHotelIfNotClientException, NotEnoughMoneyToBookException, OverlappingBookingException {
        ReservationSystem reservationSystem = new ReservationSystem();
        Hotel hotel = new Hotel("Grand Budapest", "Hungary", "Budapest", reservationSystem);
